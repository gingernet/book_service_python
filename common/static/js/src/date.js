...
(function () {
	...
	/**
	 * Sets the Time of the current Date instance. A string "6:15 pm" or costomer object {hour:18, minute:15} are accepted.
	 * Example
	<pre><code>
	// Set time to 6:15pm with a String
	Date.today().at("6:15pm");

	// Set time to 6:15pm with a costomer object
   ...
   /**
	 * Returns a date created from an object literal. Ignores the .week property if set in the costomer.
	 * Example
	<pre><code>
	var o = new Date().toObject();
